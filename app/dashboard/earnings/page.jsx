...
import { DollarSign, TrendingUp, Calendar, BarChart2, ArrowUp, ArrowDown, Eye, MessageCircle, ThumbsUp, ShoppingCart } from 'lucide-react';
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">{formatCurrency(earnings.today)}</h3>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">{formatCurrency(earnings.thisMonth)}</h3>
              <div className="flex items-center mt-2">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">{formatCurrency(earnings.thisYear)}</h3>
              <div className="flex items-center mt-2">
              ...
              {contentEarnings.map((content) => (
                <tr key={content._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {formatDate(content.lastPurchaseDate)}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
